...
class ZoomInIdeTool : VoqalTool() {

    companion object {
        const val NAME = "zoom_in_ide"
    }
    ...
    override suspend fun actionPerformed(args: JsonObject, directive: VoqalDirective) {
        ...
        log.debug("Zooming in IDE")
        project.service<VoqalToolService>().executeAnAction(
            emptyMap(),
            ActionManager.getInstance().getAction("ZoomInIdeAction")
        )
        project.service<VoqalStatusService>().updateText("Zoomed in IDE")
    }
