...
//    fun `test markdown edit`() {
//        val json = JsonObject(
//            "{ \"content\": \"```markdown\\n## Solving the Fibonacci Sequence Problem\\n\\nBelow are implementations of the Fibonacci sequence in various programming languages.\\n\\n### Python\\n\\n```python\\ndef fibonacci(n):\\n    a, b = 0, 1\\n    while a < n:\\n        print(a, end=' ')\\n        a, b = b, a + b\\n    print()\\n\\nfibonacci(1000)\\n```\\n\\n### JavaScript\\n\\n```javascript\\nfunction fibonacci(n) {\\n    let a = 0, b = 1, sum;\\n    while (a < n) {\\n        console.log(a);\\n        sum = a + b;\\n        a = b;\\n        b = sum;\\n    }\\n}\\n\\nfibonacci(1000);\\n```\\n\\n### Java\\n\\n```java\\npublic class Fibonacci {\\n    public static void main(String[] args) {\\n        int a = 0, b = 1;\\n        while (a < 1000) {\\n            System.out.print(a + \\\" \\\");\\n            int sum = a + b;\\n            a = b;\\n            b = sum;\\n        }\\n    }\\n}\\n```\\n\\n### C++\\n\\n```cpp\\n#include <iostream>\\n\\nvoid fibonacci(int n) {\\n    int a = 0, b = 1;\\n    while (a < n) {\\n        std::cout << a << \\\" \\\";\\n        int sum = a + b;\\n        a = b;\\n        b = sum;\\n    }\\n    std::cout << std::endl;\\n}\\n\\nint main() {\\n    fibonacci(1000);\\n    return 0;\\n}\\n```\\n\\n### C#\\n\\n```csharp\\nusing System;\\n\\nclass Program {\\n    static void Main() {\\n        int a = 0, b = 1;\\n        while (a < 1000) {\\n            Console.Write(a + \\\" \\\");\\n            int sum = a + b;\\n            a = b;\\n            b = sum;\\n        }\\n    }\\n}\\n```\\n\\n### Kotlin\\n\\n```kotlin\\nfun fibonacci(n: Int) {\\n    var a = 0\\n    var b = 1\\n    while (a < n) {\\n        print(\\\"\$a \\\")\\n        val sum = a + b\\n        a = b\\n        b = sum\\n    }\\n    println()\\n}\\n\\nfun main() {\\n    fibonacci(1000)\\n}\\n```\\n\\n### Swift\\n\\n```swift\\nfunc fibonacci(_ n: Int) {\\n    var a = 0, b = 1\\n    while a < n {\\n        print(a, terminator: \\\" \\\")\\n        let sum = a + b\\n        a = b\\n        b = sum\\n    }\\n    print()\\n}\\n\\nfibonacci(1000)\\n```\\n\\n### Ruby\\n\\n```ruby\\ndef fibonacci(n)\\n    a, b = 0, 1\\n    while a < n\\n        print \\\"#{a} \\\"\\n        a, b = b, a + b\\n    end\\n    puts\\nend\\n\\nfibonacci(1000)\\n```\\n\\n### PHP\\n\\n```php\\n<?php\\nfunction fibonacci(\$n) {\\n    \$a = 0;\\n    \$b = 1;\\n    while (\$a < \$n) {\\n        echo \$a . \\\" \\\";\\n        \$sum = \$a + \$b;\\n        \$a = \$b;\\n        \$b = \$sum;\\n    }\\n    echo \\\"\\\\n\\\";\\n}\\n\\nfibonacci(1000);\\n?>\\n```\\n\\n### Go\\n\\n```go\\npackage main\\n\\nimport \\\"fmt\\\"\\n\\nfunc fibonacci(n int) {\\n    a, b := 0, 1\\n    for a < n {\\n        fmt.Print(a, \\\" \\\")\\n        sum := a + b\\n        a = b\\n        b = sum\\n    }\\n    fmt.Println()\\n}\\n\\nfunc main() {\\n    fibonacci(1000)\\n}\\n```\\n\\n### Rust\\n\\n```rust\\nfn fibonacci(n: i32) {\\n    let mut a = 0;\\n    let mut b = 1;\\n    while a < n {\\n        print!(\\\"{} \\\", a);\\n        let sum = a + b;\\n        a = b;\\n        b = sum;\\n    }\\n    println!();\\n}\\n\\nfn main() {\\n    fibonacci(1000);\\n}\\n```\\n```\" }"
//        )
...
//            runBlocking {
//                EditTextTool().doDocumentReplaces(project, content, testEditor)
//            }
//        })
...
//        assertEquals(
//            content.substringAfter("```markdown\n").substringBeforeLast("\n```").length.toDouble(),
//            testEditor.document.textLength.toDouble(),
//            1.0 //todo: why
//        )
//    }

//    fun `test markdown2 edit`() {
//        val json = JsonObject(
//            "{ \"content\": \"```java\\npublic class Calculator {\\n    public int add(int a, int b) {\\n        return a + b;\\n    }\\n\\n    public int subtract(int a, int b) {\\n        return a - b;\\n    }\\n\\n    public int multiply(int a, int b) {\\n        return a * b;\\n    }\\n\\n    public int divide(int a, int b) {\\n        if (b == 0) {\\n            throw new IllegalArgumentException(\\\"Cannot divide by zero!\\\");\\n        }\\n        return a / b;\\n    }\\n}\\n```\\n\\n```kotlin\\nfun main() {\\n    val calculator = Calculator()\\n    println(calculator.add(5, 3))\\n    println(calculator.subtract(10, 7))\\n    println(calculator.multiply(4, 6))\\n    println(calculator.divide(20, 5))\\n}\\n```\\n\\n```python\\nfrom math import floor\\n\\nclass Calculator:\\n    def add(self, a, b):\\n        return a + b\\n\\n    def subtract(self, a, b):\\n        return a - b\\n\\n    def multiply(self, a, b):\\n        return a * b\\n\\n    def divide(self, a, b):\\n        if b == 0:\\n            raise ValueError(\\\"Cannot divide by zero!\\\")\\n        return a / b\\n```\\n\" }"
//        )
//        val content = json.getString("content")
//        val testDocument = EditorFactory.getInstance().createDocument("")
//        val testEditor = EditorFactory.getInstance().createEditor(testDocument, project)
...
//    fun `test replace visible range edit`() {
...
//
//        val testRange = ProperTextRange(178361, 183890)
//        val responseCode = """
//            		finally {
//            			exitRule();
//            			preExitRule();
...
//            val rangeHighlighters = WriteCommandAction.runWriteCommandAction(project, ThrowableComputable {
//                runBlocking {
//                    EditTextTool().doDocumentReplaces(project, responseCode, editor)
//                }
//            })
//            project.service<VoqalStatusService>().update(VoqalStatus.IDLE)
//
//            testContext.verify {
//                assertEquals(3, rangeHighlighters.size)
//            }
